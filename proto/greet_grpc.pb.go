...
type GreetServiceClient interface {
	...
	SayHelloBiDirectionalStreamin(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBiDirectionalStreaminClient, error)
}
...
func (c *greetServiceClient) SayHelloBiDirectionalStreamin(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBiDirectionalStreaminClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], "/greet_service.GreetService/SayHelloBiDirectionalStreamin", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceSayHelloBiDirectionalStreaminClient{stream}
	return x, nil
}

type GreetService_SayHelloBiDirectionalStreaminClient interface {
	Send(*HelloRequest) error
	Recv() (*HelloResponse, error)
	grpc.ClientStream
}

type greetServiceSayHelloBiDirectionalStreaminClient struct {
	grpc.ClientStream
}

func (x *greetServiceSayHelloBiDirectionalStreaminClient) Send(m *HelloRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceSayHelloBiDirectionalStreaminClient) Recv() (*HelloResponse, error) {
	m := new(HelloResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreetServiceServer interface {
	...
	SayHelloBiDirectionalStreamin(GreetService_SayHelloBiDirectionalStreaminServer) error
...
func (UnimplementedGreetServiceServer) SayHelloBiDirectionalStreamin(GreetService_SayHelloBiDirectionalStreaminServer) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloBiDirectionalStreamin not implemented")
}
...
func _GreetService_SayHelloBiDirectionalStreamin_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloBiDirectionalStreamin(&greetServiceSayHelloBiDirectionalStreaminServer{stream})
}

type GreetService_SayHelloBiDirectionalStreaminServer interface {
	Send(*HelloResponse) error
	Recv() (*HelloRequest, error)
	grpc.ServerStream
}

type greetServiceSayHelloBiDirectionalStreaminServer struct {
	grpc.ServerStream
}

func (x *greetServiceSayHelloBiDirectionalStreaminServer) Send(m *HelloResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceSayHelloBiDirectionalStreaminServer) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SayHelloBiDirectionalStreamin",
			Handler:       _GreetService_SayHelloBiDirectionalStreamin_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
